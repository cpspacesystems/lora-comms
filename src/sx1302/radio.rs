...
mod tests {
    ...
    fn test_try_receive() {
        ...
        let d4c: Vec<&[u8]> = d4.iter().map(|x| x.as_slice()).collect();
    ...
    fn test_try_send() {
        ...
        s.configure().unwrap();
        let r = s.try_send(c1, Payload::new());
