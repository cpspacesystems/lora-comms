use crate::{common_config::{LORA_125KHZ_CH0, LORA_125KHZ_CH3, LORA_PREAMBLE_LENGTH, UPLINK_SELECTED_CH}, lr1121::LR1121Config};
...
pub const LR1121_CONFIG: LR1121Config = LR1121Config {
    ...
    rst: 5, busy: 6, irq: 7,
    freq: (UPLINK_SELECTED_CH as f32)/1_000_000.0, bw: 125.0, sf: 7, 
